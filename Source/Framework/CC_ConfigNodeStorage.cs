...
{ 
    public abstract class CC_ConfigNodeStorage : IPersistenceLoad, IPersistenceSave
    {
        #region Constructors
        /// <summary>
        /// Class Constructor
        /// </summary>
        public CC_ConfigNodeStorage() { }
        /// <summary>
        /// Class Constructor
        /// </summary>
        ...
        public CC_ConfigNodeStorage(String FilePath) { this.FilePath = FilePath; }
        #endregion
