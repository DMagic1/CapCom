...
namespace CapCom.Framework
{
	...
	internal class CC_KSPAddonImproved : Attribute
	{
		[Flags]
		public enum Startup
		{
		...
		public CC_KSPAddonImproved(Startup mask, bool once = false)
		{
			runOnce = once;
			scenes = mask;
		}
	...
	internal class CustomAddonLoader : MonoBehaviour
	{
		...
		class AddonInfo
		{
			...
			public readonly CC_KSPAddonImproved addon;
			public bool created;

			internal AddonInfo(Type t, CC_KSPAddonImproved add)
			{
				type = t;
				created = false;
			...
			internal CC_KSPAddonImproved.Startup Scenes
			{
				get
				{
					return addon.scenes;
		...
		void Awake()
		{
			...
			{
				var attr = ((CC_KSPAddonImproved[])ourType.GetCustomAttributes(typeof(CC_KSPAddonImproved), true)).SingleOrDefault();
				if (attr != null)
				{
		...
		void OnLevelWasLoaded(int level)
		{
			...
			CC_KSPAddonImproved.Startup mask = 0;
			...
			switch (scene)
			{
				case GameScenes.EDITOR:
					mask = CC_KSPAddonImproved.Startup.Editor;
					break;

				case GameScenes.CREDITS:
					mask = CC_KSPAddonImproved.Startup.Credits;
					break;

				case GameScenes.FLIGHT:
					mask = CC_KSPAddonImproved.Startup.Flight;
					break;

				case GameScenes.LOADING:
					mask = CC_KSPAddonImproved.Startup.Instantly;
					break;

				case GameScenes.MAINMENU:
					mask = CC_KSPAddonImproved.Startup.MainMenu;
					break;

				case GameScenes.SETTINGS:
					mask = CC_KSPAddonImproved.Startup.Settings;
					break;

				case GameScenes.SPACECENTER:
					mask = CC_KSPAddonImproved.Startup.SpaceCenter;
					break;

				case GameScenes.TRACKSTATION:
					mask = CC_KSPAddonImproved.Startup.TrackingStation;
					break;

				case GameScenes.PSYSTEM:
					mask = CC_KSPAddonImproved.Startup.PSystemSpawn;
					break;
